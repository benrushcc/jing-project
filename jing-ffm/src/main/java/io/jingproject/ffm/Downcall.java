...
// the JVM could support variadic functions, heap segment arguments, or VM-level
// error handling, but doing so would make the system overly complex.
// keeping downcalls straightforward and lightweight is our first concern.
@Retention(RetentionPolicy.SOURCE)
@Target(ElementType.METHOD)
public @interface Downcall {
    // linked methodName in the shared library, it's recommended to use
    ...
    // whether the function could return immediately without extra checking.
    // this option is dangerous because it removes the safepoint check.
