...
int jing_epoll_in(void) { return EPOLLIN; }

int jing_epoll_out(void) { return EPOLLOUT; }

int jing_epoll_default(void) { return EPOLLERR | EPOLLHUP; }

int jing_epoll_ctl_add(void) { return EPOLL_CTL_ADD; }

int jing_epoll_ctl_mod(void) { return EPOLL_CTL_MOD; }

int jing_epoll_ctl_del(void) { return EPOLL_CTL_DEL; }

int jing_epoll_cloexec(void) { return EPOLL_CLOEXEC; }
