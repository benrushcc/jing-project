...
public final class SegmentAccess {
    ...
    private static final ValueLayout.OfChar CHAR_UNALIGNED_LE =
            ByteOrder.nativeOrder().equals(ByteOrder.LITTLE_ENDIAN)
    ...
    public static long getAddress(MemorySegment segment, long offset) {
    ...
    public static void setAddress(MemorySegment segment, long offset, long address) {
